      ...
      <Stack spacing={2} direction="row">
        ...
        <Stack sx={{flex: 1, p: 3, justifyContent: "center"}}>
          ...
          <Stack direction="row" sx={{mt: 2, mb: 1, width: "100%", alignSelf: "center"}}>
            ...
            <Box sx={{flex: 0.2}}/>
            {!isCompanion ? (
              <Button variant="action" onClick={startAwakenCompanion} sx={{flex: 1}}><Typography>Awaken</Typography></Button>
            ) : (
              <Button variant="action" onClick={hibernateCompanion} sx={{flex: 1}}><Typography>Hibernate</Typography></Button>
            )}
          </Stack>
          <Button variant="action" onClick={openReleaseModal} sx={{flex: 1, width: "50%", alignSelf: "center"}}><Typography>Release</Typography></Button>
        </Stack>
      </Stack>
    </Stack>
  );
